...
import { getPublicStatsAction } from "@/lib/actions/stats.actions";
import { PublicStats } from "@/lib/types/stats";
...
const Home = () => {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      const data = await getPublicStatsAction();
      if (data) {
        setStats(data);
      }
    };
